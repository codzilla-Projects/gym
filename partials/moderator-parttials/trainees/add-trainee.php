	...
	<div class="card-data">
		...
		<form method="post" action="#" enctype="multipart/form-data">
			<div class="row">
				...
				<div class="col-12 col-md-6">
					<div class="input-group">
						...
						<?php  while ($plans->have_posts()): $plans->the_post();  $uid = get_the_ID(); 						?> 
							<option value="<?php echo get_the_id() ?>"  <?php if($user_plan == $uid ){echo "selected";}?> ><?php echo the_title(); ?></option>
						<?php endwhile; ?>						
	              		</select>
                  		</select>
					</div>			
			...
			<div class="row">
				...
				<?php */ ?>
				<div class="col-12 col-md-6">
					<div class="input-group private-item">
				      <input type="checkbox" id="gym-user-has-private"  name="gym-user-has-private"  onclick='handleClick(this)'  value="1" <?= $data->has_private_trainer ?'checked' : ''; ?>>
						<label for="gym-user-has-private">Trainee has a private coach</label>
