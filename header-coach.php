<?php gym_user_login_check_redirect('coach'); ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <?php 
        $pages = get_pages(array(
          ...
          foreach ($pages as $page) {
              $coach_dashboard = get_page_link($page->ID);
          }
        ...
        <div id="layoutSidenav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                      <a href="<?php echo $coach_dashboard ?>" class="main-logo"> 
                               <img class="img-fluid" src="<?php echo get_option('sh_logo_img') ?>" alt ="Pull It Gym" >
                      </a>
                    <?php 

                        $ml_p_trainee_plan       = get_option('ml_p_trainee_plan');
                    ...
                    <div class="nav">                             
                      <ul class="main-menu">
                        <li>
                          <a href="<?php echo $coach_dashboard ?>">
                               <img class="img-fluid" src="<?php echo SH_URL . "assets/svg/trainee.svg" ?>" alt ="Pull It Gym" >
                               <span>Trainee</span>                                    
                          </a>
                        </li>
                          <li>
                        ...
                        <li>
                          <a href="<?php echo get_the_permalink($ml_game_page) ?>">
                               <img class="img-fluid" src="<?php echo SH_URL . "assets/svg/games.svg" ?>" alt ="Pull It Gym" >
                               <span>Games</span>                                   
                          </a>
                        </li>
                         <li>
